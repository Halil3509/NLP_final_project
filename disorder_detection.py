...
class DisorderDetection:
    ...
    def _get_model(self, model_path=r"C:\Users\halilibrahim.hatun\Documents\NLP\bert_alpha_v4.pt"):
        try:
    ...
    def _get_label_classes(self, path=r"C:\Users\halilibrahim.hatun\Documents\NLP\label_classes.yaml"):
    ...
    def run_disorder_detection(self):
        ...
        # Divide according to dot. Because, we want to get every sentence.
        ...
        return self.divide_dict_values(total_result_dict, len(self.text))